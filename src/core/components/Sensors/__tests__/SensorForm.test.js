...
describe('SensorForm', () => {
  ...
  test('calls createSensor with correct data on form submission', async () => {
    ...
    fireEvent.change(screen.getByLabelText(/Type/i), { target: { value: 'Temperature' } });
    fireEvent.change(screen.getByLabelText(/Driver/i), { target: { value: 'Driver1' } });
    fireEvent.change(screen.getByLabelText(/Status/i), { target: { value: '1' } });
    fireEvent.change(screen.getByLabelText(/Value/i), { target: { value: '25.5' } });
